  ...
  return (
    <>
      ...
      <div className="flex flex-wrap sm:justify-start justify-center gap-8 animate-slideup">
        <div className="flex flex-col  justify-center items-center w-[320px] h-[320px]   bg-gray-900 dark:bg-gray-100 rounded-md">
          <div className="flex flex-col items-center transition duration-300 ease-in-out hover:scale-125">
            ...
            <h3 className="text-white dark:text-black font-bold pt-5">
              +886-2-22222222
            </h3>
          </div>
        </div>

        <div className="w-[320px] h-[320px]  flex flex-col  justify-center items-center  bg-gray-900 dark:bg-gray-100  rounded-md">
          <div className="flex flex-col items-center transition duration-300 ease-in-out hover:scale-125">
            <svg
              width="50"
              height="50"
